        ...
        const body = `
          <div style="max-width:600px;margin:0 auto;padding:12px;
            ...
            <p style="font-size:16px;line-height:1.6;">
              ...
              <strong>${appointment?.time}</strong> has been marked as
              <span style="color:#2b6cb0;font-weight:bold;">complete</span>.
            </p>

            <div style="background:#e6f3ff;border:1px solid #90cdf4;
                        border-radius:8px;padding:16px;margin:24px 0;">
              <p style="margin:0;font-size:15px;color:#2d3748;">
                <strong>Appointment ID:</strong> <code style="background:#f0f9ff;padding:2px 6px;border-radius:4px;font-family:monospace;">${appointment?.appointmentId}</code>
              </p>
            </div>
            ...
            <div style="background:#f7fafc;border:1px solid #e2e8f0;
                        border-radius:8px;padding:16px;margin:24px 0;">
              <p style="margin:0;font-size:15px;color:#2d3748;">
                We appreciate your trust and hope the visit met your expectations.
              </p>
            </div>
